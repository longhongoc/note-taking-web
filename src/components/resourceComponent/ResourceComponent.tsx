...
import { LuPlus, LuLink, LuFolder, LuChevronDown } from 'react-icons/lu';
import {
  Form,
  FormControl,
  FormField,
  ...
  return (
    <>
      <div className=" w-[319px] h-[201px] border-t-[1px] border-[#BEDDED] p-[16px]">
        <div className=" w-[287px] h-[20px] flex justify-between items-center">
          <span>
            <LuLink className=" inline" /> Resources
          </span>{' '}
          <LuChevronDown
            className={cn('inline cursor-pointer', { 'rotate-180': dataShow })}
        ...
        <div className=" w-[287px] h-[32px] mt-4">
          <Dialog open={openResource} onOpenChange={setOpenResource}>
            <DialogTrigger asChild>
              <button
                className={cn(
                  ' w-[287px] h-[32px] rounded-[8px] text-14-20-500 !text-[#000E1C] shadow-[0px_1px_2px_0px_#0000000D] cursor-pointer border-2 border-[#BEDDED]',
                  { 'opacity-50': !currentProject }
                )}
              ...
              >
                ...
                >
                  ...
                  <DialogContent className=" w-[448px] bg-[#ECFBFF] shadow-[0px_4px_6px_-4px_#0000001A] border-1px-BEDDED">
                    ...
                    <Form {...formResource}>
                      <form
                        onSubmit={handleSubmit(onSubmitResourceChange)}
                        className=" w-full flex flex-col justify-between gap-4 hide-scrollbar"
                      >
                        <FormField
                          control={control}
